...
static const char *fonts[]     = { "SauceCodePro Nerd Font Mono:regular:size=10:antialias=true:hinting=true"
                                   "Ubuntu:weight=regular:size=10:antialias=true:hinting=true",
